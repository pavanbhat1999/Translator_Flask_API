...
#filet("d.pdf")
    ...
    newfile = '/root/Silfra/'+fild+"new.txt"
    ...
    filename = '/root/Silfra/'+fild+"new.txt"
    fh = open(filename,'r')
    contents = fh.read()
    #####print(contents)
    ...
    out_file.close() 
    oo = open('test1.json','r')
    print(oo.read())
    
   
    
#filet(sys.argv[1],sys.argv[2],sys.argv[3])    
'''
